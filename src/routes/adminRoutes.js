...
router.get("/", async (req, res) => {
  try {
    const [
      ...
      pool.query("SELECT COUNT(*) AS c FROM languages"),
      pool.query("SELECT COUNT(*) AS c FROM learning_tracks"),
      pool.query("SELECT COUNT(*) AS c FROM words"),
    ...
    const html = layout(
      ...
      <div class="stat-row">
        <div class="stat-card blue">
          ...
          <div class="num">${Number(langCount[0].c || 0)}</div>
        ...
        <div class="stat-card orange">
          ...
          <div class="num">${Number(userCount[0].c || 0)}</div>
