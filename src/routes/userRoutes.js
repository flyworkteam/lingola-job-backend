...
// POST /api/users/me/activity — uygulama açıldığında çağrılır: last_activity_at güncellenir, opsiyonel push token kaydedilir.
// Body: { fcm_token?: string } // Firebase token veya OneSignal subscription id
